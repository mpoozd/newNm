...
function resize_crop_image_us($nw,$nh,$source_path,$source_image_name,$dest_name,$name_ext,$crop=true)

	{
...

		{
			...
			switch($name_ext) {
				...
				$simg = imagecreatefromgif($source_path.$source_image_name);

				break;

				case 'jpg':

				$simg = imagecreatefromjpeg($source_path.$source_image_name);

				break;

				case 'png':

				$simg = imagecreatefrompng($source_path.$source_image_name);
