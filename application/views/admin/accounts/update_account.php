                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                ...
                                <input type="text" name="admin_name" value="<?php if($this->input->post("admin_name") != ""){ echo $this->input->post("admin_name"); } else { echo $account['admin_name']; } ?>" placeholder="Name" class="form-control"> </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                ...
                                <input type="text" name="admin_email" value="<?php if($this->input->post("admin_email") != ""){ echo $this->input->post("admin_email"); } else { echo $account['admin_email']; } ?>" placeholder="Email" class="form-control"> </div>
                           		<input type="hidden" name="admin_old_email" value="<?php echo $account['admin_email']; ?>"/>
                        </div>
                    </div>
