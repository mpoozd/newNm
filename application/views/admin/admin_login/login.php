...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url() ?>assets/admin/assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <?php 
	 	$this->session->set_flashdata('login_error_message', "");
		 } ?>
        ...
        <div class="content">
            ...
            <form class="login-form" action="" method="post">
                ...
                <div class="form-group">
					...
					<?php if(@$_COOKIE['cook_name_user'] == ''){ ?>
                    
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" placeholder="Email" name="admin_email" value="<?php if($this->input->post("admin_email") != ''){ echo $this->input->post("admin_email");  } ?>" />
                    
					<?php } else { ?>
                    
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" placeholder="Email" name="admin_email" value="<?=$_COOKIE['cook_name_user']?>" />
                ...
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                     ...
                     <?php if(@$_COOKIE['cook_pass_user'] == ''){ ?>
                     
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" placeholder="Password" name="admin_password" value="<?php if($this->input->post("admin_password") != ""){ echo $this->input->post("admin_password"); } ?>" />
                    
                    <?php } else { ?>    
                    
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" placeholder="Password" name="admin_password" value="<?=$_COOKIE['cook_pass_user']?>" />
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo base_url() ?>admin/login/forget_password" id="forget-password" class="forget-password">Forgot Password?</a>
                </div>
...
<![endif]-->
        ...
        <script src="<?php echo base_url() ?>assets/admin/assets/pages/scripts/login.min.js" type="text/javascript"></script>
