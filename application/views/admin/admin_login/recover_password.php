...
<html lang="en">
    ...
    <body class=" login">
        ...
        <?php if($this->session->flashdata('forget_error_message') != "") {?>  
        <div class="alert alert-danger alert-dismissable">
       		<button class="close" aria-hidden="true" data-dismiss="alert" type="button"></button>
        	<?php echo $this->session->flashdata('forget_error_message'); ?>
        </div>
        <?php 
	 	$this->session->set_flashdata('forget_error_message', "");
		 } ?>
        ...
        <div class="content">
            ...
            <form class="" action="" method="post">
                ...
                <div class="form-group">
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Email" name="user_email" value="<?php if($this->input->post('user_email') != ""){ echo $this->input->post('user_email'); }?>" /> </div>
                <div class="form-actions">
                    <a href="<?php echo base_url() ?>admin/login"><button type="button" id="back-btn" class="btn green btn-outline">Back</button></a>
