<h3 class="page-title">Update Company Employer<small>  </small> </h3>
...
<form role="form" action="" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group col-md-6">
        <label>Name</label>
        <input type="text" placeholder="" name="cemp_name" value="<?php if($this->input->post('cemp_name') != ""){ echo $this->input->post('cemp_name'); } else { echo $cemp_info['cemp_name']; } ?>" class="form-control <?php if(form_error('cemp_name')){?> error_border <?php } ?>"> 
    </div>

    <div class="form-actions col-md-12" style="text-align:center;">
        <button class="btn green" type="submit">Update Company Employer</button>
    </div>	
