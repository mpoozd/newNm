...
<option value="<?php echo $ftype_name_row['ftype_id'] ?>"<?php if ($this->input->post('ftype_name') == $ftype_name_row['ftype_id']) {echo $selected;} ?> ><?php echo $ftype_name_row['ftype_name']; ?></option>
                                            <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                ...
                                <input type="text" name="question" value="<?php if($this->input->post("question") != ""){ echo $this->input->post("question"); } ?>" placeholder="Question" class="form-control"> </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea id="page_content" name="answer" placeholder="Answer" rows="3" class="form-control"><?php if($this->input->post("answer") != ""){ echo $this->input->post("answer"); }?></textarea>
                        </div>
                    </div>
