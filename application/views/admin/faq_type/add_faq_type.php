<h3 class="page-title">  Add Faq Type <small>  </small> </h3>
...
<form role="form" action="" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group col-md-6">
        <label>Name</label>
        <input type="text" placeholder="" name="ftype_name" value="<?php if($this->input->post('ftype_name') != ""){ echo $this->input->post('ftype_name'); } ?>" class="form-control <?php if(form_error('ftype_name')){?> error_border <?php } ?>"> 
    </div>

    <div class="form-actions col-md-12" style="text-align:center;">
        <button class="btn green" type="submit">Add Faq Type</button>
    </div>	
