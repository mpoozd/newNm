            ...
            <div class="portlet-body">
                ...
                <form role="form" class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                ...
                                <input type="text" name="nl_title" value="<?php if($this->input->post("nl_title") != ""){ echo $this->input->post("nl_title"); } else { echo $newsletter['nl_title']; } ?>" placeholder="Title" class="form-control"> </div>
                   ...
                   <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea name="nl_body" rows="3" class="form-control" id="page_content"><?php if($this->input->post("nl_body") != ""){ echo $this->input->post("nl_body"); } else { echo $newsletter['nl_body']; } ?></textarea>
                                                </div>
                                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                ...
                                <input type="text" name="nl_month" value="<?php if($this->input->post("nl_month") != ""){ echo $this->input->post("nl_month"); }  else { echo $newsletter['nl_month']; } ?>" placeholder="Month" class="form-control"> </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon right">
                                ...
                                <input type="text" name="nl_email" value="<?php if($this->input->post("nl_email") != ""){ echo $this->input->post("nl_email"); } else { echo $newsletter['nl_email']; } ?>" placeholder="Email" class="form-control">
                                <input type="hidden" name="nl_email_old" value="<?php echo $newsletter['nl_email'] ?>"/>
                                 </div>
