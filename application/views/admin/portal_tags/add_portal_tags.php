<h3 class="page-title">  Add Portal Tags <small>  </small> </h3>
...
<form role="form" action="" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group col-md-6">
        <label>Name</label>
        <input type="text" placeholder="" name="tag_name" value="<?php if($this->input->post('tag_name') != ""){ echo $this->input->post('tag_name'); } ?>" class="form-control <?php if(form_error('tag_name')){?> error_border <?php } ?>"> 
    </div>

    <div class="form-actions col-md-12" style="text-align:center;">
        <button class="btn green" type="submit">Add Portal Tags</button>
    </div>	
