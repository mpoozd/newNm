<h3 class="page-title">Update Specialist<small>  </small> </h3>
...
<form role="form" action="" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group col-md-6">
        <label>Name</label>
        <input type="text" placeholder="" name="spe_name" value="<?php if($this->input->post('spe_name') != ""){ echo $this->input->post('spe_name'); } else { echo $universties_info['spe_name']; } ?>" class="form-control <?php if(form_error('spe_name')){?> error_border <?php } ?>"> 
    </div>

    <div class="form-actions col-md-12" style="text-align:center;">
        <button class="btn green" type="submit">Update Specialist</button>
    </div>	
