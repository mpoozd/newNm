<h3 class="page-title">Update University<small>  </small> </h3>
...
<form role="form" action="" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group col-md-6">
        <label>Name</label>
        <input type="text" placeholder="" name="univ_name" value="<?php if($this->input->post('univ_name') != ""){ echo $this->input->post('univ_name'); } else { echo $universties_info['univ_name']; } ?>" class="form-control <?php if(form_error('univ_name')){?> error_border <?php } ?>"> 
    </div>
    
    

    <div class="form-actions col-md-12" style="text-align:center;">
        <button class="btn green" type="submit">Update University</button>
    </div>	
