...
?><meta charset="utf-8">
    ...
    <link rel="icon" href="<?=base_url()?>assets/img/favicon.ico">  <link rel="stylesheet" media="screen" href="<?=base_url()?>bootstrap-select-1.10.0/dist/css/bootstrap-select.min.css" type="text/css"/>
    <style>
