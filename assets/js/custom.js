...
$(function() {
  jQuery(document).ready(function(){
   // jQuery(".job_add_steps").hide().parent().find(".job-step-1").show();
    //jQuery('.tsf-nav-step li').on('click',function(){
      //var element = jQuery(this);
      //var tgt = element.attr('data-target');
      //jQuery('.tsf-nav-step li[class="current"]').removeAttr('class');
      //jQuery(".job_add_steps").hide();
      //jQuery('.job-'+tgt).show();
